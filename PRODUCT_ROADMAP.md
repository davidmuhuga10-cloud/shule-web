...
4. **Up next: Phase 2 (Exam Workflow Maturity)** — exam types, the publishing workflow, richer student/staff profiles, and printouts expansion. I'll scope and build this the same way: verified in a sandbox (or simulated Postgres instance) before it touches your live data, real unit tests per module.
5. This document stays the living source of truth — each phase's section gets a status update like Phase 0, Phase 1, and Phase 1.5's above as it ships, rather than a separate changelog.
